...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descricao: @tarefa.descricao, prazo: @tarefa.prazo, status: @tarefa.status, usuario_id: @tarefa.usuario_id } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descricao: @tarefa.descricao, prazo: @tarefa.prazo, status: @tarefa.status, usuario_id: @tarefa.usuario_id } }
